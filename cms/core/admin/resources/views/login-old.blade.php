								...
								<table class="login-table mat-5">
									...
									<tr>
										<td>
                                            ...
                                            {!! Form::text('username', Cookie::get('username'), array('id'=>'username','class' => 'form-control input-fields-input login-input useremail','required' => 'required','placeholder'=>'Enter Username','autocomplete'=>"off")) !!}
