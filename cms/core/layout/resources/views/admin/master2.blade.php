...
<head>
    ...
    <link type="text/css" href="{{ asset("assets/backend/js/bootstrap-timepicker/css/bootstrap-timepicker.min.css") }}" />
  ...
  {!!Cms::style('theme/vendors/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.min.css')!!}
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-datetimepicker/2.5.3/jquery.datetimepicker.css"/>
...
<body class="nav-md">
    <div class="wrapper" id="app">
         <!-- sidebar menu -->
          ...
          <div class="page-wrapper">
			...
			<div class="page-content-wrapper_popup">
                <div class="page-content">
                    ...
                    <div class="alert alert-success border-0 bg-success alert-dismissible fade show">
                        <div class="text-white">{{session("invoice")}} <a href="{{asset(session("invoicelink"))}}" class="alert-link" style="color:white;" target="_blank">view Invoice</a>.</div>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="alert alert-danger border-0 bg-danger alert-dismissible fade show">
                        <div class="text-white">{{session("exception_error_link")}} <a href="{{session("link")}}" class="alert-link" style="color:white;" target="_blank">Click here</a>.</div>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                ...
                <div class="alert alert-success border-0 bg-success alert-dismissible fade show">
                    <div class="text-white">{{session("success_student")}}
                       ...
                       <p>For Parent</p>
                        ...
                        <p>Password : {{session("parent_password")}}</p></div>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
    ...
    {{-- {!! Cms::script('theme/vendors/plugins/apexcharts-bundle/js/apexcharts.min.js') !!} --}}
    ...
    {!! Cms::script('theme/vendors/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.min.js') !!}
