...
class MenuController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        $data = UserModel::select(
            ...
            DB::raw(
                "(CASE WHEN " .
                    DB::getTablePrefix() .
                    'users.status = "0" THEN "Disabled" ELSE "Enabled" END) AS status'
            ),
            "images"
        )
    ...
    function getMenuUrl()
    {
        $pages = PageModel::where("status", 1)
            ->select("title", "url", "id")
            ->get();
        ...
        return json_encode(["status" => 1, "pages" => $pages]);
    }
    ...
    function menuAssign()
    {
        ...
        return view("wmenu::admin.menu_assign", [
