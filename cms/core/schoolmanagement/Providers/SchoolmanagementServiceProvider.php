...
namespace cms\core\schoolmanagement\Providers;
...
class SchoolmanagementServiceProvider extends ServiceProvider
{
    ...
    public function registerRoute()
    {
        // Route::prefix('')
        //     ->middleware(['web'])
        //     ->namespace('cms\schoolmanagement\Controllers')
    ...
    public function registerViews()
    {
        ...
        $viewPath = resource_path("views/modules/schoolmanagement");
        ...
        $sourcePath =
            ...
            "/cms/local/" .
            $theme .
            "/schoolmanagement/resources/views";
        ...
        $this->loadViewsFrom(
            array_merge(
                array_map(
                    function ($path) {
                        return $path . "/modules/schoolmanagement";
                    },
                    [$Path]
                ),
                [$sourcePath, $Path]
