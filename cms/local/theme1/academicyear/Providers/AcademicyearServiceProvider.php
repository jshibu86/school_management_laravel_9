...
namespace cms\academicyear\Providers;
...
class AcademicyearServiceProvider extends ServiceProvider
{
    ...
    public function registerViews()
    {
        ...
        $viewPath = resource_path('views/modules/academicyear');

        //$sourcePath = __DIR__.'/../resources/views';
        $Path = __DIR__.'/../resources/views';
        $sourcePath = base_path().'/cms/local/'.$theme.'/academicyear/resources/views';

        $this->publishes([
            $sourcePath => $viewPath
        ]);
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/academicyear';
        }, [$Path]), [$sourcePath,$Path]), 'academicyear');
    }
    /*
     * register middleware
     */
