...
<div class="card">
    <div class="card-body">
        <div class="card-title btn_style">
            <h4 class="mb-0">View Income Expense Category</h4>
            @if(CGate::allows('create-account'))
            <a class="btn btn-primary btn-sm m-1  px-3" href="{{route('accountcategory.create')}}" ><i class='fa fa-plus'></i>&nbsp;&nbsp;Create</a>
            @endif
...
@section('script')
    <script>
     window.statuschange='{{route('accountcategory_action_from_admin')}}';
        $('document').ready(function(){

            var element = $("#datatable-buttons1");
            var url =  '{{route('get_accountcategory_data_from_admin')}}';
            var column = [
