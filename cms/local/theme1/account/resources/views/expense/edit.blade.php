...
@section('body')
    <div class="x_content">
        ...
        @if($layout == "create")
            {{ Form::open(array('role' => 'form', 'route'=>array('expense.store'), 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal form-label-left', 'id' => 'account-form','novalidate' => 'novalidate')) }}
        @elseif($layout == "edit")
            {{ Form::open(array('role' => 'form', 'route'=>array('expense.update',$data->id), 'method' => 'put', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal form-label-left', 'id' => 'user-form','novalidate' => 'novalidate')) }}
        @endif
        <div class="box-header with-border mar-bottom20">
            ...
            @endif
             ...
             <a class="btn btn-info btn-sm m-1  px-3" href="{{route('expense.index')}}" ><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;&nbsp;Back</a>
           ...
           @include("layout::admin.breadcrump",['route'=> $layout == "edit" ?"Edit Expense" : "Create Expense"])

             <div class="card">
                <div class="card-body">
                    <h5 class="card-title">{{$layout == "edit" ?"Edit Expense" : "Create Expense"}}</h5>
                    <hr/>
                    <div class="col-xs-12">
                        <div class="row">
                          ...
                          <div class="item form-group">
                           <label class="control-label margin__bottom" for="status">Academic year <span class="required">*</span>
                                ...
                                <div class="feild">
                                    ...
                                    array('id'=>'status_','class' => 'single-select form-control','required' => 'required','placeholder'=>"Select Category")) }}
                                </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                            <div class="item form-group">
                                <label class="control-label margin__bottom" for="status">Expense Title <span class="required">*</span>
                                </label>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                         ...
                         <div class="col-xs-12 col-sm-4 col-md-3">
                            <div class="item form-group">
                                ...
                                <div class="feild">
                                    {{Form::number('amount',@$data->amount,array('id'=>"name",'class'=>"form-control col-md-7 col-xs-12 " ,
