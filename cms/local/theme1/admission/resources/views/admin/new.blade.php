...
@section('body')
    <div class="x_content">
        ...
        @if($layout == "new")
            {{ Form::open(array('role' => 'form', 'route'=>array('admission.store'), 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal form-label-left', 'id' => 'teacher-form','novalidate' => 'novalidate')) }}
        @elseif($layout == "edit")
            {{ Form::open(array('role' => 'form', 'route'=>array('admission.update',$data->id), 'method' => 'put', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal form-label-left', 'id' => 'user-form','novalidate' => 'novalidate')) }}
        @endif
        <div class="box-header with-border mar-bottom20">
            {{ Form::button('<i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;Save New Admission', array('type' => 'submit', 'id' => 'submit_btn', 'name' => 'submit_cat' , 'value' => 'Edit_teacher' , 'class' => 'btn btn-success btn-sm m-1  px-3')) }}

            <a class="btn btn-info btn-sm m-1  px-3" href="{{route('admission.index')}}" ><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;&nbsp;Back</a>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Edit Admission Student Details</h5>
                <hr/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="">
                                                        <input class="form-control thumb" type="file" id="imagec_img_student" name="imagec" data-id="student"  accept="image/png, image/jpeg" value="{{ @$data->image }}">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item form-group">
                                                ...
                                                <div class="feild ss">
                                                    ...
                                                    array('id'=>'academic_year','class' => 'single-select form-control select2')) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item form-group">
                                                ...
                                                <div class="feild">
                                                    ...
                                                    array('id'=>'transportation','class' => 'form-control single-select',"required"=>"required","placeholder"=>"Select class" )) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item form-group">
                                                ...
                                                <div class="feild">
                                                {{Form::text('father_name',@$data->parent_name,array('id'=>"fathername",'class'=>"form-control col-md-7 col-xs-12" ,
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item form-group">
                                                ...
                                                <div class="feild">
                                                {{Form::text('father_email',@$data->parent_email,array('id'=>"father_email",'class'=>"form-control col-md-7 col-xs-12" ,
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item form-group">
                                                ...
                                                <div class="feild">
                                                {{Form::text('father_mobile',@$data->parent_mobile,array('id'=>"father_mobile",'class'=>"form-control col-md-7 col-xs-12" ,
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item form-group">
                                                ...
                                                <div class="feild">
                                                {{Form::text('house_no',@$data->house_no,array('id'=>"house_no",'class'=>"form-control col-md-7 col-xs-12" ,
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item form-group">
                                                ...
                                                <div class="feild">
                                                {{Form::text('street_name',@$data->street,array('id'=>"street_name",'class'=>"form-control col-md-7 col-xs-12" ,
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item form-group">
                                                ...
                                                <div class="feild">
                                                {{Form::text('postal_code',@$data->postal_code,array('id'=>"postal_code",'class'=>"form-control col-md-7 col-xs-12" ,
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item form-group">
                                                ...
                                                <div class="feild">
                                                {{Form::text('province',@$data->city,array('id'=>"province",'class'=>"form-control col-md-7 col-xs-12" ,
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item form-group">
                                                ...
                                                <div class="feild">
                                                {{Form::text('country',@$data->country,array('id'=>"country",'class'=>"form-control col-md-7 col-xs-12" ,
