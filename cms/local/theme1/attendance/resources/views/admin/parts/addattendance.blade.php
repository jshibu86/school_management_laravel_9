            ...
            <div class="container">
                ...
                <div class="att_div bg-white border_r_8 p-4 row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h4>{{ @$type === "hourly" ? "Hourly" : 'Daily'}} Attendance ({{ @$hr }})</h4>
                            ...
                            <div class="col-md-7">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <h6 class="font_text"><b>{{ @$acyear }} / {{ @$term_info }}</b></h6>
                                    </div>
                                    <div class="col-md-3">
                ...
                <div class="att_div bg-white border_r_8 p-4 row mt-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <h4>Mark attendance for selected hour</h4>
                        ...
                        <div class="att_table my-4">
                            ...
                            <div class="row row_data my-2 align-items-center">
                                ...
                                <div class="col-md-3">
                                    ...
                                    array('id'=>'class_id','class' => 'form-c period_selecthr period_select att_select ','placeholder'=>"Select Attendance",'required'=>"required")) }}
                                    @else
                                    {{ Form::select('attendences['.$student->id.']',Configurations::ATNTYPES,null ,
                                    array('id'=>'class_id','class' => 'form-c period_selecthr period_select att_select ','placeholder'=>"Select Attendance",'required'=>"required")) }}
                                    @endif
                                    @else 
                                    {{ Form::select('attendences['.$student->id.']',Configurations::ATNTYPES,null ,
