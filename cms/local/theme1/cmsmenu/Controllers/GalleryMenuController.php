...
class GalleryMenuController extends Controller
{
    ...
    {
        $events_menu = GalleryMenuModel::get();
        $menu = $events_menu->pluck("value", "key")->toArray();
        return view("cmsmenu::admin.gallery.gallerymenu", ["data" => $menu]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $eventsmenu = GalleryMenuModel::all();
        ...
        return redirect()->route("gallerymenu.index");
    }
