...
@section('body')
    <div class="x_content">
            ...
            {{ Form::open(array('role' => 'form', 'route'=>array('gallerymenu.store'), 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal form-label-left', 'id' => 'classteacher-form','novalidate' => 'novalidate')) }}
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Gallery Menu</h5>
                <hr/>
                <div class="col-xs-12">
                    <div class="row">
                        <div class="col-md-4">
