     ...
     window.statuschange='{{route('dormitory_action_from_admin')}}';
        $('document').ready(function(){
            ...
            var column = [
                ...
                { data: 'dormitory_name', name: 'dormitory_name', width: '15%' },
                { data: 'dormitory_type', name: 'dormitory_type' , className: 'textcenter' },
                { data: 'dormitory_address', name: 'dormitory_address' , className: 'textcenter' },
                { data: 'totalrooms', name: 'totalrooms' , className: 'textcenter' },
