...
@section('script')
    <script>
       window.statuschange='{{route('event_action_from_admin')}}';
        $('document').ready(function(){

            var element = $("#datatable-buttons1");
            var url =  '{{route('get_event_data_from_admin')}}';
            var column = [
              
                {data: 'DT_RowIndex', name: 'DT_RowIndex',searchable: false,sortable: false},
                { data: 'event_name', name: 'event_name', width: '15%' },
                { data: 'event_date', name: 'event_date' , className: 'textcenter' },
