...
<div class="x_content">
         ...
         <div class="card">
            <div class="card-body">
                                            ...
                                            @if(@$data)
                                                @if(@$data->attachment)
                                                    ...
                                                    <div class="card_attachment">
                                                        ...
                                                        <img src="{{ asset($data->attachment) }}" alt="Animated Card Hover Effect Html & CSS" class="img-fluid">
                                                        ...
                                                        @else
                                                        <div class="bg-white w-100 h-auto text-center"><i class='bx bxs-file-pdf text-secondary my-3' style="font-size:50px;"></i></div>
                                                        @endif
                                                        <div class="overlay">
                                ...
                                <div class="">
                                    ...
                                    <p class="fw-bold">Attachment :</p>
                                        <div class="card_attachment">
                                            ...
                                            @if($attachment_extension == "jpg" || $file_extension == "png" || $file_extension == "gif")
                                            <img src="{{ asset($answer->attachment) }}" alt="Animated Card Hover Effect Html & CSS">
                                            @elseif ($attachment_extension == 'mp4' || $file_extension == 'avi' || $file_extension == 'mov')  
                                            <img src="{{ asset('assets/sample/images.png') }}" alt="Animated Card Hover Effect Html & CSS">
              ...
              <button type="button" class="btn btn-danger" style="float:right;" data-bs-dismiss="modal">Cancel</button>
            </div>
        </div>
