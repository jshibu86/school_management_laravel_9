...
@section('body')
<section>
    {{ Form::open(array('role' => 'form', 'route'=>array('onlineexam.store'), 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal form-label-left', 'id' => 'exam-form','novalidate' => 'novalidate')) }}
