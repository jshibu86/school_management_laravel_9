...
<html>
  ...
  <style>
    ...
    .receipt {
     ...
     /* Ensure the last receipt doesn't add an extra blank page */
    .receipt:last-child {
...
<body>
    @foreach($student_details as $key=>$student_info)
    <center class="receipt">
      <div class="fees_bill_table">
        ...
        <table class="fees_bill2">
          ...
          <tr>
            ...
            <td class="sub_data1 sub_main2" colspan="2">
              ...
              {{ @$term_name }}/<span>N</span>{{ @$paid_amount[$key] }}
            </td>
            <td class="sub_datap1 sub_main2 sub_titlep1" colspan="2">
              <span>N</span>{{ @$paid_amount[$key] }}
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="sub_data2 sub_main3 fee" colspan="2">
              <span style="font-family: DejaVu Sans;"><span>N</span>{{ @$paid_amount[$key] }}
        ...
        <table class="fees_bill3">
          <tr>
            ...
            <td class="sub_data2" colspan="1"> <span>N</span>{{ @$paid_amount[$key] }}</td>
          </tr>
