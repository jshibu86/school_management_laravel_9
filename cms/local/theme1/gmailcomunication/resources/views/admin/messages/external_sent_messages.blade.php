...
@if($external_sent_messages->links() !== null)
    <div class="pagination-info row" data-group="external_sent">
        <div class="col-6 my-3">
            Showing {{ $external_sent_messages->firstItem() }}-{{ $external_sent_messages->lastItem() }} of {{ $external_sent_messages->total() }}
        </div>
        <div class="col-6 my-3">
            {{$external_sent_messages->links() }}
        </div>
    </div>
@endif