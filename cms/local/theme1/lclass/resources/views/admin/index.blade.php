...
<div class="card">
    <div class="card-body">
        <div class="card-title btn_style">
            ...
            @if(CGate::allows("create-lclass"))
            <a class="btn btn-primary btn-sm m-1  px-3" href="{{route('lclass.create')}}" ><i class='fa fa-plus'></i>&nbsp;&nbsp;Create Class</a>
            @endif
...
@section('script')
    <script>
         window.statuschange='{{route('lclass_action_from_admin')}}';
        $('document').ready(function(){

            var element = $("#datatable-buttons1");
            var url =  '{{route('get_lclass_data_from_admin')}}';
            var column = [
            ...
            var options  = {
                ...
                button : [
                    ...
                    {
                        name : "Trash",
                        url : "{{route('lclass_action_from_admin',-1)}}"
                    },
                    {
                        name : "Delete",
                        url : "{{route('lclass.destroy',1)}}",
                        method : "DELETE"
                    }
                ],
