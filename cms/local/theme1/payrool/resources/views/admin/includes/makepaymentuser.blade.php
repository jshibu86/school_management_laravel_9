                            ...
                            <div class="col-md-12">
                                ...
                                <div class="att_table my-4">
                                    ...
                                    <div class="row row_head">
                                        ...
                                        {{-- <div class="col-md-3 mt-2">
                                            <h6 class="mb-0">
                                             ...
                                             Deduction {{Configurations::getConfig("site")->currency_symbol}}
                                            </h6>
                                        </div> --}}
                                    ...
                                    <div class="row row_data my-2 align-items-center">
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <input type="hidden" name="basic_salery[]" value="{{@$user->salerypayroll->grade->basic_salery ?? 0}}"/>
                                            <input type="hidden" name="deduction[]" value="{{@$user->salerypayroll->grade->total_deduction ?? 0}}"/>
                                            <input type="hidden" name="grade[]" value="{{@$user->salerypayroll->grade->id }}"/>
                                        </div>
                                        <div class="col-md-3">
                                            <h6 class="mb-0 sub_txt">
                                        ...
                                        <div class="col-md-3">
                                            <h6 class="mb-0 sub_txt">{{ @$user->salerypayroll->grade->basic_salery ?? "NIL" }}</h6>
                                        </div>
                                        {{-- <div class="col-md-3">
                                            <h6 class="mb-0 sub_txt">{{ @$user->salerypayroll->grade->total_deduction ?? "NIL" }}</h6>
                                        </div> --}}
                                ...
                                <div class="row ">
                                    <div class="col-md-12 text-right" style="text-align: right;">
                                        <button type="submit" class="btn add_btn"> <i class="fa fa-check-circle-o"></i>&nbsp;&nbsp;&nbsp;Make Payment</button>
                                    </div>
                                </div>
                                @endif
