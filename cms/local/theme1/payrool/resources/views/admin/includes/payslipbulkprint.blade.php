...
<body>
    <div class="button-class">
        <a href="{{ route('payrollbulkprint') }}" class="button-back">Back</a>
            ...
            @if (in_array($user->id, $data))
                <div class="fees_bill_table">
                    <table class="fees_bill1" align="center">
                        ...
                        <tr>
                            <td class="school_data1" colspan="2">
                                {{ Configurations::getConfig('site')->school_email }}</td>
                            <td class="school_data2" colspan="2"> {{ Configurations::getConfig('site')->place }},
                                {{ Configurations::getConfig('site')->city }} ,
                                {{ Configurations::getConfig('site')->country }}</td>
                        </tr>
                        <tr>
                            <td class="school_data1" colspan="2">
                                {{ Configurations::getConfig('site')->school_phone }}</td>
                    ...
                    @if (@$view)
                        @php
                            $viewDeduction = 0;
                            $basic_per = 100;
                            foreach (@$user->salerypayrollpayment->particulars as $particular) {
                        ...
                        @php
                            ...
                            if (@$view) {
                                $basic = $user->salerypayrollpayment->basic_salery - $viewDeduction;
                                $tax =
                                    $user->salerypayrollpayment->deduction['tax_per'] == 0
                                        ? $user->salerypayrollpayment->deduction['tax_amount']
                                        : ($basic * $user->salerypayrollpayment->deduction['tax_per']) / 100;
                                $employer_pension =
                                    ($basic * $user->salerypayrollpayment->deduction['employer_pension_per']) / 100;
                                $employee_pension =
                                    ($basic * $user->salerypayrollpayment->deduction['employee_pension_per']) / 100;
                            } else {
                        ...
                        <table class="fees_bill2">
                            ...
                            <tr>
                                ...
                                <td class="sub_data1" colspan="2">{{ $user->username }}</td>
                            ...
                            <tr>
                                ...
                                <td class="sub_data1 sub_main2" colspan="2">
                                    ...
                                    {{ $user->salerypayrollpayment->payment_date }}

                                </td>
                                <td class="sub_datap1 sub_main2 " colspan="2"
                                    style="width: 13%;
              text-align: left;">
                        ...
                        <table class="fees_bill3">
                            ...
                            <tr>
                                ...
                                <td class="sub_data2 border_bottom">
                                    {{ @$salery_payment->basic_salery - @$viewDeduction }}</td>
                        ...
                        @else
                            <tr>
                                ...
                                <td class="sub_title1 border_bottom">Basic ({{ $basic_per }}%)</td>
                                <td class="sub_data2 border_bottom">
                                    {{ @$grade->basic_salery - @$grade->total_deduction }}</td>
                                <td class="sub_data2 border_bottom"></td>
                            </tr>
                    @endif
                    ...
                    @if (@$view)
                        @foreach (@$user->salerypayrollpayment->particulars as $particular)
                            <tr>
                                ...
                                <td class="sub_title1 border_bottom">
                                    {{ Configurations::getParticular($particular['particular_id']) }}
                                    ({{ $particular['deduction_per'] }}%)
                                </td>
                    ...
                    @else
                        @foreach (@$grade->particulars as $particular)
                            <tr>
                                ...
                                <td class="sub_title1 border_bottom">
                                    <span>NG</span>{{ Configurations::getParticular($particular['particular_id']) }}
                                </td>
                                <td class="sub_data2 border_bottom">{{ $particular['deduction_amount'] }}</td>
                                <td class="sub_data2 border_bottom"></td>
                            </tr>
                ...
                <div class="fees_bill_table">
                    <table class="fees_bill1" align="center">
                        <tr>
                            ...
                            <td class="school"> {{ Configurations::getConfig('site')->school_name }}</td>
                            <td class="sub_title" colspan="3">Salary Slip[
                                {{ $user->salerypayrollpayment ? $user->salerypayrollpayment->payslip_no : '' }}
                                ]
