...
namespace cms\productbrand\Providers;
...
class ProductbrandServiceProvider extends ServiceProvider
{
    ...
    public function registerViews() {
        ...
        $viewPath = resource_path('views/modules/productbrand');

        //$sourcePath = __DIR__.'/../resources/views';
        $Path = __DIR__.'/../resources/views';
        $sourcePath = base_path().'/cms/local/'.$theme.'/productbrand/resources/views';

        $this->publishes([
            $sourcePath => $viewPath
        ]);
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/productbrand';
        }, [$Path]), [$sourcePath,$Path]), 'productbrand');
    }
