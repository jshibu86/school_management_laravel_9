...
namespace cms\productcategory\Providers;
...
class ProductcategoryServiceProvider extends ServiceProvider
{
    ...
    public function registerViews() {
        ...
        $viewPath = resource_path('views/modules/productcategory');

        //$sourcePath = __DIR__.'/../resources/views';
        $Path = __DIR__.'/../resources/views';
        $sourcePath = base_path().'/cms/local/'.$theme.'/productcategory/resources/views';

        $this->publishes([
            $sourcePath => $viewPath
        ]);
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/productcategory';
        }, [$Path]), [$sourcePath,$Path]), 'productcategory');
    }
