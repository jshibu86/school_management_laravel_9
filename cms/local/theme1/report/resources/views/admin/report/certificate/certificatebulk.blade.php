...
<div class="card">
    <div class="card-body">
        <div class="card-title btn_style">
            <h4 class="mb-0">Student Certificate Bulk Print</h4>
                ...
                <div id="collapseOne" class=" atnaccodrdian accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
                    <div class="accordion-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 ">
                                <button type="submit" id="addatt" class="btn btn-primary  add_btn att_btn w-100" name="daily"> <i class="fa fa-plus" name="daily"></i>&nbsp;&nbsp;Print Certificate</button>
                            </div>

                            <div class="col-md-3 ">
                                <button type="button" id="addatt" style="margin-top:26px" class="btn btn-outline-primary w-100" name="daily"> <i class="fa fa-envelope" name="daily"></i>&nbsp;&nbsp;Send Mail</button>
                            </div>
