          ...
          <table style="width: 100%;border: 1px solid black;border-collapse: collapse;">
            <tbody>
              <tr style="font-weight: 700;">
                ...
                <td style="color: #4e1489;border: 1px solid black;padding:15px 6px 15px 6px;">
                  <span>TERM:</span>
                  <span style="color: #000;"> {{@$selected_term}}  @if (Configurations::getConfig("site")->promotion_type ==0) /Cumulative @endif</span>
                </td> 
                <td style="color: #4e1489;border: 1px solid black;padding:15px 6px 15px 6px;">
                  <span>SESSION:</span>
                ...
                <td style="color: #4e1489;border: 1px solid black;padding:15px 6px 15px 6px;">
                  <span> STATUS :</span>
                  <span style="color: #379242">Passed</span>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table style="width: 100%;border: 1px solid black;border-collapse: collapse;">
            <tbody>
              <tr style="font-weight: 700;">
                ...
                <td style="color: #4e1489;border: 1px solid black;padding: 15px 6px 15px 6px;">
                  <span>POSITION:</span>
                  <span style="color: #000;">61<sup>st</sup></span>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table border="1" class="main-table" style="width: 100%;border: 1px solid black;border-collapse: collapse;">
            <tbody  align="center">
              ...
              @endif
                {{-- changes --}}
              <tr>
                  @if (Configurations::getConfig("site")->promotion_type ==1)
              ...
              <tr>
                ...
                <td style="color: #4e1489;border: 1px solid black;padding: 10px 6px 10px 6px;">{{$info->total_mark}}</td>
