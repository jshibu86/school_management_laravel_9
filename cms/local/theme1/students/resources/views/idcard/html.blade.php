...
{{-- <div class="id-card-tag"></div> --}}
  ...
  <div class="id-card-holder">
    <div class="id-card">
      ...
      @if (@$student->user)
        <div class="photo">
            <img src="{{ @$student->user->images ?  @$student->user->images : "/assets/images/default.jpg" }}" alt="user_image"/>
      
        </div>
      @endif
      
     
      <h4 style="margin: 0">{{@$student->first_name}} {{@$student->last_name}}</h4>
      <h5 style="margin: 0">{{@$student->reg_no}}</h5>
      <h5 style="margin: 0">Class : {{@$student->class->name}} / {{@$student->section->name}}</h5>
