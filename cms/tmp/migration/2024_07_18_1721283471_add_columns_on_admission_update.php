...
class AddColumnsOnAdmissionUpdate extends Migration
{
    ...
    public function up()
    {
        Schema::table('admission', function (Blueprint $table) {
            ...
            $table->string("religion")->nullable()->after("reject_msg");     
            $table->string("stu_document_upload1")->nullable()->after("religion");
            $table->string("stu_document_upload2")->nullable()->after("stu_document_upload1");
        });
    }
