    ...
    $.extend(MultiSelect.prototype, {
        ...
        constructPresets: function () {
            ...
            $.each(this.settings["presets"], function (i, preset) {
                ...
                $input
                    .on("change.multiselect", function () {
        ...
        constructMenuItemsGroup: function ($optgroup, optgroup_index) {
            ...
            $optgroup.children("option").each(function (option_index, option) {
                var $item = _this.constructMenuItem(
                    $(option),
                    optgroup_index + "_" + option_index
                );
        ...
        menuShow: function () {
            ...
            if (
                ...
                var menuLeftEdge =
                    this.$menu.offset().left + this.$menu.outerWidth();
                var withinLeftEdge =
                ...
                if (menuLeftEdge > withinLeftEdge) {
                    this.$menu.css(
                        "width",
                        withinLeftEdge - this.$menu.offset().left
                    );
                    this.$container.addClass(
                        this.settings["positionedMenuClass"]
                    );
                }
            }
            ...
            if (
                menuBottom >
                viewportBottom - this.settings["viewportBottomGutter"]
            ) {
                this.$menu.css({
                    maxHeight: Math.max(
                        viewportBottom -
        ...
        checkBlur: function (e) {
            if (
                e.relatedTarget &&
                !$(e.relatedTarget).closest(this.$container).length
            ) {
                this.menuHide();
            }
        },
