        ...
        b.extend(d.prototype, {
            ...
            init: function () {
                ...
                "fade" === this.options.animation &&
                    this.elem.addClass(
                        "ui-pnotify-fade-" + this.options.animate_speed
                    );
            ...
            position: function (c) {
                ...
                if (a) {
                    ...
                    if (!d || c) {
                        a.modal &&
                            (a.overlay ? a.overlay.show() : (a.overlay = s(a)));
                        ...
                        switch (a.dir2) {
                            case "down":
                            case "up":
                                b.outerHeight(!0) > a.addpos2 &&
                                    (a.addpos2 = b.height());
                                break;
                            case "left":
                            case "right":
                                b.outerWidth(!0) > a.addpos2 &&
                                    (a.addpos2 = b.width());
                        }
                        "number" === typeof a.nextpos1 &&
                            (a.animation
